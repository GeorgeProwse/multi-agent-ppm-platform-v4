/**
 * ConnectorCard - Individual connector card within a category section.
 * Displays status badges, toggle switch, and action buttons.
 */

import styles from '../connectors/ConnectorGallery.module.css';
import { ConnectorIcon } from './ConnectorIcon';
import { McpProjectConfigSection } from './McpProjectConfigSection';
import {
  STATUS_LABELS,
