/**
 * CertificationModal - Modal for viewing / editing certification evidence
 * (compliance status, audit references, and document uploads) for a connector.
 */
...
import type { CertificationModalProps, CertificationRecord } from './projectConnectorTypes';
