/**
 * ConnectorConfigModal - Full configuration modal for a single connector.
 * Handles MCP / REST transport settings, connection fields, sync settings,
 * and the "Test Connection" workflow.
 */
