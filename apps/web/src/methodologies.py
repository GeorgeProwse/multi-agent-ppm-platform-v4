        ...
        "monitoring": [
            ...
            },
            {
                ...
                "assistant_prompts": [
                    ...
                    "Research emerging risks using external sources and categorise them.",
            ...
            {
                "id": "monitoring-vendors",
                "name": "Vendor watchlist",
                "description": "Monitor vendor performance signals and supplier health.",
                "assistant_prompts": [
                    "Research vendor performance signals and highlight emerging concerns.",
                    "Summarize vendor financial health or disputes with source links.",
                    "Recommend actions to mitigate supplier risks.",
                ],
                "prerequisites": [],
                "category": "monitoring",
                "recommended_canvas_tab": "document",
            },
            {
                ...
                "description": "Track regulatory updates and compliance implications.",
                "assistant_prompts": [
                    "Monitor new regulations affecting this project domain and region.",
                    "Summarize compliance updates with source links.",
                    "Suggest control or documentation updates for new requirements.",
                ],
                "prerequisites": [],
                "category": "monitoring",
                "recommended_canvas_tab": "dashboard",
