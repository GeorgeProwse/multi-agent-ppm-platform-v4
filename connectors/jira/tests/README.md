# Jira Connector Test Assets

## Purpose

Store fixtures and connector-level test scaffolding for the Jira integration.

## What's inside

- [fixtures](/connectors/jira/tests/fixtures): Subdirectory containing fixtures assets for this area.
