# Teams Connector Test Assets

## Purpose

Store fixtures and connector-level test scaffolding for the Teams integration.

## What's inside

- [fixtures](/connectors/teams/tests/fixtures): Subdirectory containing fixtures assets for this area.
