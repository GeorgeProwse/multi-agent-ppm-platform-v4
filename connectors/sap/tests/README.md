# Sap Connector Test Assets

## Purpose

Store fixtures and connector-level test scaffolding for the Sap integration.

## What's inside

- [fixtures](/connectors/sap/tests/fixtures): Subdirectory containing fixtures assets for this area.
