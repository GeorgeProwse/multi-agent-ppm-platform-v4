...
Define how Salesforce payloads map into the platform's canonical schemas under `data/schemas/`.
...
```bash
python -m tools.connector_runner run-connector --name salesforce --dry-run
```
