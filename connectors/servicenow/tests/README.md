# Servicenow Connector Test Assets

## Purpose

Store fixtures and connector-level test scaffolding for the Servicenow integration.

## What's inside

- [fixtures](/connectors/servicenow/tests/fixtures): Subdirectory containing fixtures assets for this area.
...
```bash
pytest connectors/servicenow/tests
```
