# Workday Connector Test Assets

## Purpose

Store fixtures and connector-level test scaffolding for the Workday integration.

## What's inside

- [fixtures](/connectors/workday/tests/fixtures): Subdirectory containing fixtures assets for this area.
...
```bash
pytest connectors/workday/tests
```
