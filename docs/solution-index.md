...
| Agents & Orchestration | `docs/architecture/agent-orchestration.md`, `agents/AGENT_CATALOG.md` | Orchestration flow, catalog of 25 agents, Azure Service Bus event bus | Implemented (docs + runtime scaffolding + event bus) |
...
| Connectors & Integrations | `docs/connectors/overview.md`, `docs/connectors/supported-systems.md`, `docs/connectors/mcp-server-configuration.md`, `docs/connectors/mcp-connector-development.md`, `docs/connectors/mcp-connector-onboarding.md` | Integration architecture, connector principles, MCP configuration, connector maturity | Implemented (40 connectors across PPM/ERP/GRC/HR/Collaboration/Communications domains including Jira, Azure DevOps, SAP, Workday, Planview, Clarity, ServiceNow, Salesforce, Slack, Teams, M365, Confluence, SharePoint, Monday, Asana, Smartsheet, Oracle, NetSuite, ADP, SAP SuccessFactors, LogicGate, RSA Archer, Google Drive, Google Calendar, Outlook, Zoom, Twilio, Azure Communication Services, Azure Notification Hubs, IoT, MS Project Server, and MCP variants for key systems; mock connectors for local dev; connector SDK and registry included) |
