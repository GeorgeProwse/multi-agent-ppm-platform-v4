...
| Connectors & Integrations | `docs/connectors/overview.md`, `docs/connectors/supported-systems.md`, `docs/connectors/mcp-server-configuration.md`, `docs/connectors/mcp-connector-development.md`, `docs/connectors/mcp-connector-onboarding.md` | Integration architecture, connector principles, MCP configuration, connector maturity | Implemented (Planview, Clarity, SAP, Workday, Salesforce, Slack, Teams, ServiceNow connectors now covered) |
