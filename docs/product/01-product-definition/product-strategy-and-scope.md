...
- **Connectors** — bi-directional integration with 32 enterprise systems (38 production-ready connectors including MCP variants, 2 in development) across PPM, ERP, HRIS, collaboration, and GRC categories. For the full connector catalog, see [Connector Documentation](../../connectors/).
