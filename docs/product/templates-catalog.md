...
| Business case update report | Compare actuals vs plan to validate continued investment. | Agent 05/12 (Business Case & Investment) | [docs/templates/shared/reports/business-case-update.md](../templates/shared/reports/business-case-update.md) |
...
| Variance report | Track schedule/cost variance. | Agent 10 (Schedule & Planning) | [docs/templates/shared/reports/variance-report.md](../templates/shared/reports/variance-report.md) |
| Executive dashboard status report | Executive-ready health, decisions, and value summary. | Agent 21 (Stakeholder Comms) | [docs/templates/shared/reports/status-report.md](../templates/shared/reports/status-report.md) |
| Milestone review | Formal milestone, phase gate, or go/no-go review. | Agent 09 (Lifecycle & Governance) | [docs/templates/shared/reports/milestone-review.md](../templates/shared/reports/milestone-review.md) |
| Risk report | Report top risks and exposure trends. | Agent 15 (Risk & Issue Management) | [docs/templates/shared/reports/risk-report.md](../templates/shared/reports/risk-report.md) |
...
| Quality report | Report quality performance and defects. | Agent 14 (Quality Assurance) | [docs/templates/shared/reports/quality-report.md](../templates/shared/reports/quality-report.md) |
| Quality checklist | Standardize quality reviews and acceptance criteria. | Agent 14 (Quality Assurance) | [docs/templates/shared/checklists/quality-checklist.md](../templates/shared/checklists/quality-checklist.md) |
...
| Issue log | Track and resolve issues. | Agent 15 (Risk & Issue Management) | [docs/templates/shared/issue-log.md](../templates/shared/issue-log.md) |
| Lessons learned register | Capture outcomes, root causes, and recommendations. | Agent 20 (Continuous Improvement) | [docs/templates/shared/reports/lessons-learned.md](../templates/shared/reports/lessons-learned.md) |
| Scope baseline | Combine scope statement, WBS, and dictionary. | Agent 08 (Project Definition) | [docs/templates/shared/scope-baseline.md](../templates/shared/scope-baseline.md) |
| Project scope statement | Define the approved project scope, boundaries, and acceptance criteria. | Agent 08 (Project Definition) | [docs/templates/shared/project-scope-statement.md](../templates/shared/project-scope-statement.md) |
...
| Business requirements document | Capture business goals, requirements, and success metrics. | Agent 08 (Project Definition) | [docs/templates/shared/business-requirements-document.md](../templates/shared/business-requirements-document.md) |
| Software requirements specification | Define detailed functional and non-functional requirements. | Agent 08 (Project Definition) | [docs/templates/shared/requirements-specification.md](../templates/shared/requirements-specification.md) |
| Requirements traceability matrix | Map requirements to design, build, and test artifacts. | Agent 08 (Project Definition) | [docs/templates/shared/requirements-traceability-matrix.md](../templates/shared/requirements-traceability-matrix.md) |
...
| RACI matrix | Define responsibilities, accountability, and decision rights. | Agent 11 (Resource & Capacity) | [docs/templates/shared/governance/raci-matrix.md](../templates/shared/governance/raci-matrix.md) |
...
| Template customization guide | Guide consistent tailoring and governance of templates. | Agent 09 (Lifecycle & Governance) | [docs/templates/shared/governance/template-customization-guide.md](../templates/shared/governance/template-customization-guide.md) |
...
| Contract summary | Summarize contract terms and obligations. | Agent 13 (Vendor Procurement) | [docs/templates/shared/contract-summary.md](../templates/shared/contract-summary.md) |
...
| Executive real-time dashboard specification | Define real-time executive KPIs, panels, and refresh cadence. | Agent 22/25 (Performance & Insights) | [docs/templates/shared/reports/kpi-dashboard-spec.md](../templates/shared/reports/kpi-dashboard-spec.md) |
...
| --- | --- | --- | --- |
| Charter |  | [Project charter](../templates/waterfall/planning/project-charter.md) | [Hybrid charter](../templates/hybrid/governance/hybrid-charter.md) |
| Roles & responsibilities matrix | [Roles & responsibilities](../templates/agile/roles/roles-responsibilities.md) — Defines the key roles and responsibilities for Agile projects (Product Owner, Scrum Master, Team, Stakeholders, etc.). | [Roles & responsibilities](../templates/waterfall/roles-responsibilities.md) — Defines the key roles and responsibilities for Waterfall projects (Sponsor, PM, BA, Functional Leads, etc.). | [Roles & responsibilities](../templates/hybrid/resources/roles-responsibilities.md) — Defines hybrid roles and shared responsibilities where governance and Agile delivery overlap. |
| User story mapping | [User story mapping](../templates/agile/planning/user-story-mapping-template.md) |  |  |
| User story template | [User story template](../templates/agile/planning/user-story-template.md) |  |  |
| Backlog | [Backlog](../templates/agile/planning/backlog.csv) |  |  |
| Backlog management | [Backlog management](../templates/agile/planning/backlog-management-template.md) |  |  |
| Backlog refinement | [Backlog refinement](../templates/agile/planning/backlog-refinement-template.md) |  |  |
| Risk-adjusted backlog | [Risk-adjusted backlog](../templates/agile/risk/risk-adjusted-backlog.csv) |  |  |
| Agile risk board | [Agile risk board](../templates/agile/risk/agile-risk-board.md) |  |  |
| Sprint plan | [Sprint plan](../templates/agile/planning/sprint-plan.md) |  | [Sprint plan](../templates/agile/planning/sprint-plan.md) |
| Iteration plan | [Iteration plan](../templates/agile/planning/iteration-plan.md) |  |  |
| Release plan | [Release plan](../templates/agile/planning/release-plan.md) |  | [Release plan](../templates/agile/planning/release-plan.md) |
| Burndown | [Burndown](../templates/agile/reports/burndown.xlsx) |  |  |
| WBS |  | [WBS](../templates/waterfall/planning/wbs.yaml) |  |
| Schedule baseline |  | [Schedule baseline](../templates/waterfall/planning/schedule-baseline.xlsx) |  |
| Risk register |  | [Risk register](../templates/waterfall/planning/risk-register.xlsx) | [Integrated risk register](../templates/hybrid/risk/integrated-risk-register.xlsx) |
| Integrated risk register |  |  | [Integrated risk register](../templates/hybrid/risk/integrated-risk-register.md) |
...
| Milestone plan |  |  | [Milestone plan](../templates/hybrid/plans/milestone-plan.xlsx) |
| Governance pack |  |  | [Governance pack](../templates/hybrid/governance/governance-pack.md) |
| Decision log |  |  | [Decision log](../templates/hybrid/governance/decision-log.md) |
| Hybrid team management |  |  | [Hybrid team management](../templates/hybrid/resources/hybrid-team-management.md) |
| Hybrid resource plan |  |  | [Hybrid resource plan](../templates/hybrid/resources/hybrid-resource-plan.md) |
