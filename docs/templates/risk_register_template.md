...
*Define the impact scale for evaluating risk consequences.*
...
*Define the different types of risk response strategies.*
...
### 5.2 Risk Triggers and Early Warning Signs

*Explain how to identify and use risk triggers for early risk detection.*

*Example: Risk triggers are events or circumstances that indicate a risk is about to occur or has occurred. Each risk should have identified triggers where possible. Project team members should be aware of these triggers and report them immediately when observed. Examples include:*

* *Schedule variance >5% (trigger for schedule delay risk)*
* *Team member resignation (trigger for resource availability risk)*
* *Stakeholder expressing concerns (trigger for scope change risk)*
* *Vendor missing first deliverable (trigger for vendor performance risk)*

### 5.3 Risk Status Tracking

*Define how risk status will be tracked and reported.*

*Example: Risk status will be tracked using the following designations:*

* *Identified: Risk has been identified but not yet analyzed*
* *Analyzed: Risk has been assessed for probability and impact*
* *Planned: Response strategy has been determined*
* *In Progress: Response actions are being implemented*
* *Monitoring: Risk is being actively monitored*
* *Occurred: Risk has materialized and become an issue*
* *Closed: Risk is no longer relevant to the project*
* *Residual: Risk has been addressed but residual risk remains*

---

## 6. Risk Register

*The main risk register table containing all identified risks and their assessment, response planning, and monitoring information.*

| Risk ID | Risk Description | Category | Probability (1-5) | Impact (1-5) | Risk Score | Priority | Response Strategy | Response Actions | Owner | Status | Due Date | Comments |
|---------|------------------|----------|-------------------|--------------|------------|----------|-------------------|------------------|-------|--------|----------|----------|
| *RISK-T-001* | *System integration with legacy applications may fail due to outdated APIs* | *Technical* | *4* | *5* | *20* | *High* | *Mitigate* | *1. Perform early integration testing with legacy systems<br>2. Develop API adapters<br>3. Prepare contingency plan for manual data transfer* | *John Smith* | *In Progress* | *YYYY-MM-DD* | *Integration test environment set up, preliminary tests showing compatibility issues with Finance system* |
| *RISK-S-001* | *Key resources may be unavailable during critical implementation phase due to fiscal year-end activities* | *Schedule* | *3* | *4* | *12* | *Medium* | *Mitigate* | *1. Adjust project schedule to avoid fiscal year-end<br>2. Cross-train team members<br>3. Identify backup resources* | *Jane Doe* | *Planned* | *YYYY-MM-DD* | *HR has provided list of potential backup resources* |
| *RISK-C-001* | *Vendor costs may exceed budget due to currency fluctuations* | *Cost* | *2* | *3* | *6* | *Low* | *Accept* | *Monitor currency trends, incorporate small contingency* | *Mike Johnson* | *Monitoring* | *N/A* | *Currency has been stable for past 6 months* |
| *RISK-E-001* | *Regulatory changes may require system redesign* | *External* | *2* | *5* | *10* | *Medium* | *Mitigate/Transfer* | *1. Regular regulatory monitoring<br>2. Include compliance review in design phases<br>3. Include regulatory clause in vendor contract* | *Sarah Williams* | *Monitoring* | *YYYY-MM-DD* | *Regulatory review scheduled for next month* |
| *RISK-CM-001* | *Users may resist adopting new system due to significant process changes* | *Change Management* | *4* | *4* | *16* | *High* | *Mitigate* | *1. Early stakeholder engagement<br>2. Comprehensive training program<br>3. Super-user network<br>4. Regular communication about benefits* | *Robert Brown* | *In Progress* | *YYYY-MM-DD* | *Initial stakeholder sessions completed with positive feedback* |

---

## 7. Risk History Log

*Track the history of changes to risks, including status changes, assessment changes, and response plan updates.*

| Date | Risk ID | Change Description | Previous Values | New Values | Changed By | Reason for Change |
|------|---------|--------------------|--------------------|-------------|------------|------------------|
