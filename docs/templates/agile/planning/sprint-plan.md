...
## Inputs
- Prioritized backlog (`docs/templates/agile/planning/backlog.csv`).
...
## Acceptance Criteria
- Sprint plan covers scope, capacity, and success criteria.
- Commitments are feasible and approved by Product Owner.
- Risks and dependencies have mitigation owners.
