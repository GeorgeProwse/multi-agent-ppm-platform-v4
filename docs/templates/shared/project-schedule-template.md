...
The Project Schedule is a time-based representation of project activities that documents when work
will be performed and deliverables will be produced. It supports communication, resource
management, progress tracking, and forecasting project completion.
...
### Schedule Baseline
The schedule baseline is the approved version of the project schedule that serves as the basis for
comparison to actual results. Document the baseline approval as follows:
...
| **Schedule Baseline** | Use `docs/templates/waterfall/planning/schedule-baseline.xlsx` for the time-phased baseline. |
