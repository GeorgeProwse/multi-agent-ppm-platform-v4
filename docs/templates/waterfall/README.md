...
## Shared templates used with waterfall
Additional waterfall artefacts such as scope, schedule, cost, quality, resource, procurement, risk,
and project management plans live in `docs/templates/shared` and are referenced by the methodology
maps and gates.
