...
## 4. Schedule & Budget Performance
| Metric | Planned | Actual | Variance | Explanation |
| --- | --- | --- | --- | --- |
| Duration |  |  |  |  |
| Budget |  |  |  |  |

## 5. Quality & Benefits Realization
- **Defects at closure:**
- **Customer satisfaction score:**
- **Benefits realized to date:**
- **Benefits pending:**

## 6. Risks & Issues Closure
List any risks/issues that remain open and ownership for follow-up.
| Item | Owner | Next Action | Due Date |
| --- | --- | --- | --- |
|  |  |  |  |
