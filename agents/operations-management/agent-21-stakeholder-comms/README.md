...
- [src](/agents/operations-management/agent-21-stakeholder-comms/src): Implementation source for this component.
- [tests](/agents/operations-management/agent-21-stakeholder-comms/tests): Test suites and fixtures.
- [Dockerfile](/agents/operations-management/agent-21-stakeholder-comms/Dockerfile): Container build recipe for local or CI use.
