...
- [src](/agents/operations-management/agent-19-knowledge-document-management/src): Implementation source for this component.
- [tests](/agents/operations-management/agent-19-knowledge-document-management/tests): Test suites and fixtures.
- [Dockerfile](/agents/operations-management/agent-19-knowledge-document-management/Dockerfile): Container build recipe for local or CI use.
