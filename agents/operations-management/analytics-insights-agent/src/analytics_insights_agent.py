...
# Action handlers ---------------------------------------------------------
from actions.aggregate_data import handle_aggregate_data
from actions.compute_kpis import handle_compute_kpis_batch, update_kpis_from_definitions
from actions.create_dashboard import handle_create_dashboard
from actions.data_lineage import handle_update_data_lineage
from actions.generate_narrative import handle_generate_narrative
from actions.generate_report import handle_generate_report
from actions.infrastructure import (
...
from actions.insights import handle_get_insights
from actions.periodic_report import handle_generate_periodic_report
from actions.query_data import handle_get_dashboard, handle_natural_language_query, handle_query_data
from actions.run_prediction import handle_run_prediction
from actions.scenario_analysis import handle_scenario_analysis
