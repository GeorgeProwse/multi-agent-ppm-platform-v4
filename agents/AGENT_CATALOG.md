...
### Agent 01: Intent Router Specification (`agent-01-intent-router`)
...
### Agent 02: Response Orchestration Specification (`agent-02-response-orchestration`)
...
### Agent 03: Approval Workflow Specification (`agent-03-approval-workflow`)
...
### Agent 08: Project Definition Scope Specification (`agent-08-project-definition-scope`)
...
### Agent 09: Lifecycle Governance Specification (`agent-09-lifecycle-governance`)
...
### Agent 10: Schedule Planning Specification (`agent-10-schedule-planning`)
...
### Agent 11: Resource Capacity Specification (`agent-11-resource-capacity`)
...
### Agent 12: Financial Management Specification (`agent-12-financial-management`)
...
### Agent 13: Vendor Procurement Specification (`agent-13-vendor-procurement`)
...
### Agent 14: Quality Management Specification (`agent-14-quality-management`)
...
### Agent 15: Risk Issue Management Specification (`agent-15-risk-issue-management`)
...
### Agent 16: Compliance Regulatory Specification (`agent-16-compliance-regulatory`)
...
### Agent 17: Change Configuration Specification (`agent-17-change-configuration`)
...
### Agent 18: Release Deployment Specification (`agent-18-release-deployment`)
...
### Agent 19: Knowledge Document Management Specification (`agent-19-knowledge-document-management`)
...
### Agent 20: Continuous Improvement Process Mining Specification (`agent-20-continuous-improvement-process-mining`)
...
### Agent 21: Stakeholder Comms Specification (`agent-21-stakeholder-comms`)
...
### Agent 22: Analytics Insights Specification (`agent-22-analytics-insights`)
...
### Agent 23: Data Synchronisation Quality Specification (`agent-23-data-synchronisation-quality`)
...
### Agent 24: Workflow Process Engine Specification (`agent-24-workflow-process-engine`)
...
### Agent 04: Demand Intake Specification (`agent-04-demand-intake`)
...
### Agent 05: Business Case Investment Specification (`agent-05-business-case-investment`)
...
### Agent 06: Portfolio Strategy Optimisation Specification (`agent-06-portfolio-strategy-optimisation`)
...
### Agent 07: Program Management Specification (`agent-07-program-management`)
